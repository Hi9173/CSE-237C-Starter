...
// ==============================================================
`timescale 1 ns / 1 ps
module bnn_bnn_Pipeline_l2_loop_w2_ROM_AUTO_1R (
    address0, ce0, q0, 
    address1, ce1, q1, 
    address2, ce2, q2, 
    address3, ce3, q3, 
...
initial begin
    ...
    $readmemh("./bnn_bnn_Pipeline_l2_loop_w2_ROM_AUTO_1R.dat", rom0); 
    $readmemh("./bnn_bnn_Pipeline_l2_loop_w2_ROM_AUTO_1R.dat", rom1); 
    $readmemh("./bnn_bnn_Pipeline_l2_loop_w2_ROM_AUTO_1R.dat", rom2); 
    $readmemh("./bnn_bnn_Pipeline_l2_loop_w2_ROM_AUTO_1R.dat", rom3);
end
