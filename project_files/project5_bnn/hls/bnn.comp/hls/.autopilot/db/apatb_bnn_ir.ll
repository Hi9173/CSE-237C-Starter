...
define void @apatb_bnn_ir(i16* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="49" %IN, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="10" %ys, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="128" %l1_out, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="64" %l2_out) local_unnamed_addr #0 {
entry:
  ...
  %2 = bitcast i32* %l1_out to [128 x i32]*
  %l1_out_copy = alloca [128 x i32], align 512
  %3 = bitcast i32* %l2_out to [64 x i32]*
  %l2_out_copy = alloca [64 x i32], align 512
  call fastcc void @copy_in([49 x i16]* nonnull %0, [49 x i16]* nonnull align 512 %IN_copy, [10 x i32]* nonnull %1, [10 x i32]* nonnull align 512 %ys_copy, [128 x i32]* nonnull %2, [128 x i32]* nonnull align 512 %l1_out_copy, [64 x i32]* nonnull %3, [64 x i32]* nonnull align 512 %l2_out_copy)
  call void @apatb_bnn_hw([49 x i16]* %IN_copy, [10 x i32]* %ys_copy, [128 x i32]* %l1_out_copy, [64 x i32]* %l2_out_copy)
  call void @copy_back([49 x i16]* %0, [49 x i16]* %IN_copy, [10 x i32]* %1, [10 x i32]* %ys_copy, [128 x i32]* %2, [128 x i32]* %l1_out_copy, [64 x i32]* %3, [64 x i32]* %l2_out_copy)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_in([49 x i16]* noalias readonly, [49 x i16]* noalias align 512, [10 x i32]* noalias readonly, [10 x i32]* noalias align 512, [128 x i32]* noalias readonly, [128 x i32]* noalias align 512, [64 x i32]* noalias readonly, [64 x i32]* noalias align 512) unnamed_addr #1 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a128i32([128 x i32]* align 512 %5, [128 x i32]* %4)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @onebyonecpy_hls.p0a128i32([128 x i32]* noalias align 512 %dst, [128 x i32]* noalias readonly %src) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([49 x i16]* noalias, [49 x i16]* noalias readonly align 512, [10 x i32]* noalias, [10 x i32]* noalias readonly align 512, [128 x i32]* noalias, [128 x i32]* noalias readonly align 512, [64 x i32]* noalias, [64 x i32]* noalias readonly align 512) unnamed_addr #4 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a128i32([128 x i32]* %4, [128 x i32]* align 512 %5)
  call fastcc void @onebyonecpy_hls.p0a64i32([64 x i32]* %6, [64 x i32]* align 512 %7)
  ret void
}

declare void @apatb_bnn_hw([49 x i16]*, [10 x i32]*, [128 x i32]*, [64 x i32]*)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_back([49 x i16]* noalias, [49 x i16]* noalias readonly align 512, [10 x i32]* noalias, [10 x i32]* noalias readonly align 512, [128 x i32]* noalias, [128 x i32]* noalias readonly align 512, [64 x i32]* noalias, [64 x i32]* noalias readonly align 512) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a10i32([10 x i32]* %2, [10 x i32]* align 512 %3)
  call fastcc void @onebyonecpy_hls.p0a128i32([128 x i32]* %4, [128 x i32]* align 512 %5)
  call fastcc void @onebyonecpy_hls.p0a64i32([64 x i32]* %6, [64 x i32]* align 512 %7)
...
declare void @bnn_hw_stub(i16* noalias nocapture nonnull readonly, i32* noalias nocapture nonnull, i32* noalias nocapture nonnull, i32* noalias nocapture nonnull)

define void @bnn_hw_stub_wrapper([49 x i16]*, [10 x i32]*, [128 x i32]*, [64 x i32]*) #5 {
entry:
  call void @copy_out([49 x i16]* null, [49 x i16]* %0, [10 x i32]* null, [10 x i32]* %1, [128 x i32]* null, [128 x i32]* %2, [64 x i32]* null, [64 x i32]* %3)
  %4 = bitcast [49 x i16]* %0 to i16*
  %5 = bitcast [10 x i32]* %1 to i32*
  %6 = bitcast [128 x i32]* %2 to i32*
  %7 = bitcast [64 x i32]* %3 to i32*
  call void @bnn_hw_stub(i16* %4, i32* %5, i32* %6, i32* %7)
  call void @copy_in([49 x i16]* null, [49 x i16]* %0, [10 x i32]* null, [10 x i32]* %1, [128 x i32]* null, [128 x i32]* %2, [64 x i32]* null, [64 x i32]* %3)
  ret void
}
