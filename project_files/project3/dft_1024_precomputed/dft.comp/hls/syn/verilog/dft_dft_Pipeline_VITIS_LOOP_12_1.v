...
module dft_dft_Pipeline_VITIS_LOOP_12_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln12_fu_74_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln12_fu_86_p1;
reg   [10:0] i_fu_34;
wire   [10:0] add_ln12_fu_80_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln12_fu_74_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln12_fu_74_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((icmp_ln12_fu_74_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln12_fu_80_p2 = (ap_sig_allocacmp_i_3 + 11'd1);
...
assign icmp_ln12_fu_74_p2 = ((ap_sig_allocacmp_i_3 == 11'd1024) ? 1'b1 : 1'b0);

assign imag_op_address0 = zext_ln12_fu_86_p1;
...
assign real_op_address0 = zext_ln12_fu_86_p1;
...
assign zext_ln12_fu_86_p1 = ap_sig_allocacmp_i_3;

endmodule //dft_dft_Pipeline_VITIS_LOOP_12_1
