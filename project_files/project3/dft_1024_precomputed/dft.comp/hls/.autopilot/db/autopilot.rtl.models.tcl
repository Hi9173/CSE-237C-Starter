set SynModuleInfo {
  {SRCNAME dft_Pipeline_READ_INPUT MODELNAME dft_Pipeline_READ_INPUT RTLNAME dft_dft_Pipeline_READ_INPUT
    SUBMODULES {
  ...
  {SRCNAME dft_Pipeline_COMPUTE_DFT_INNER_LOOP MODELNAME dft_Pipeline_COMPUTE_DFT_INNER_LOOP RTLNAME dft_dft_Pipeline_COMPUTE_DFT_INNER_LOOP
    SUBMODULES {
      ...
      {MODELNAME dft_dft_Pipeline_COMPUTE_DFT_INNER_LOOP_cos_coefficients_table_ROM_AUTO_1R RTLNAME dft_dft_Pipeline_COMPUTE_DFT_INNER_LOOP_cos_coefficients_table_ROM_AUTO_1R BINDTYPE storage TYPE rom IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME dft_dft_Pipeline_COMPUTE_DFT_INNER_LOOP_sin_coefficients_table_ROM_AUTO_1R RTLNAME dft_dft_Pipeline_COMPUTE_DFT_INNER_LOOP_sin_coefficients_table_ROM_AUTO_1R BINDTYPE storage TYPE rom IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
    }
  }
