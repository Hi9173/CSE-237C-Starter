...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add274_1_out \
    op interface \
    ports { add274_1_out { O 32 vector } add274_1_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add3_1_out \
    op interface \
    ports { add3_1_out { O 32 vector } add3_1_out_ap_vld { O 1 bit } } \
} "
}
