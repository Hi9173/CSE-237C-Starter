...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dft_dft_Pipeline_COMPUTE_DFT_INNER_LOOP_cos_coefficients_table_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dft_dft_Pipeline_COMPUTE_DFT_INNER_LOOP_sin_coefficients_table_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
