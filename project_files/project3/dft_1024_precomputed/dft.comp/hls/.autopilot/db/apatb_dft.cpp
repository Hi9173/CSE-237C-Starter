...
extern "C"
void apatb_dft_hw(void* __xlx_apatb_param_real_sample, void* __xlx_apatb_param_imag_sample, void* __xlx_apatb_param_real_op, void* __xlx_apatb_param_imag_op)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_real_sample),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_real_sample),
#endif
#endif
    .hasWrite = { false },
  };
  port0.param = { __xlx_apatb_param_real_sample };
  port0.mname = { "real_sample" };
  port0.nbytes = { 4096 };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_imag_sample),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_imag_sample),
#endif
#endif
    .hasWrite = { false },
  };
  port1.param = { __xlx_apatb_param_imag_sample };
  port1.mname = { "imag_sample" };
  port1.nbytes = { 4096 };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_real_op),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_real_op),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_real_op),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_real_op),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_real_op),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_real_op),
#endif
#endif
    .hasWrite = { true },
  };
  port2.param = { __xlx_apatb_param_real_op };
  port2.mname = { "real_op" };
  port2.nbytes = { 4096 };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_imag_op),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_imag_op),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_imag_op),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_imag_op),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_imag_op),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_imag_op),
#endif
#endif
    .hasWrite = { true },
  };
  port3.param = { __xlx_apatb_param_imag_op };
  port3.mname = { "imag_op" };
  port3.nbytes = { 4096 };
