...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dft_sparsemux_17_3_32_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {compactencoding_dontcare}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { cos_coefficients_table_address0 { O 10 vector } cos_coefficients_table_ce0 { O 1 bit } cos_coefficients_table_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { sin_coefficients_table_address0 { O 10 vector } sin_coefficients_table_ce0 { O 1 bit } sin_coefficients_table_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add274_out \
    op interface \
    ports { add274_out { O 32 vector } add274_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add3_out \
    op interface \
    ports { add3_out { O 32 vector } add3_out_ap_vld { O 1 bit } } \
} "
}
