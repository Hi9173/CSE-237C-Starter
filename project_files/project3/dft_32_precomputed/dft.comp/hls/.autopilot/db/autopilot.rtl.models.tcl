set SynModuleInfo {
  {SRCNAME dft_Pipeline_VITIS_LOOP_20_2 MODELNAME dft_Pipeline_VITIS_LOOP_20_2 RTLNAME dft_dft_Pipeline_VITIS_LOOP_20_2
    SUBMODULES {
      ...
      {MODELNAME dft_sparsemux_17_5_32_1_1 RTLNAME dft_sparsemux_17_5_32_1_1 BINDTYPE op TYPE sparsemux IMPL compactencoding_dontcare}
  ...
  {SRCNAME dft MODELNAME dft RTLNAME dft IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME dft_p_ZL15cos_coeff_table_21_ROM_AUTO_1R RTLNAME dft_p_ZL15cos_coeff_table_21_ROM_AUTO_1R BINDTYPE storage TYPE rom IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME dft_p_ZL15cos_coeff_table_25_ROM_AUTO_1R RTLNAME dft_p_ZL15cos_coeff_table_25_ROM_AUTO_1R BINDTYPE storage TYPE rom IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
