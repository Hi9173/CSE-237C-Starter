; ModuleID = '/home/linux/ieng6/students/769/zeh003/Desktop/CSE-237C-Starter/project_files/axis_fp/axis_fp_example.comp/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_axis_fp_example_ir(%"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %A, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %B, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %C, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %D) local_unnamed_addr #0 {
entry:
  ...
  %C_copy.data = alloca i32, align 512
  %C_copy.keep = alloca i4, align 512
  %C_copy.strb = alloca i4, align 512
  %C_copy.last = alloca i1, align 512
  %D_copy.data = alloca i32, align 512
  %D_copy.keep = alloca i4, align 512
  %D_copy.strb = alloca i4, align 512
  %D_copy.last = alloca i1, align 512
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* nonnull %A, i32* nonnull align 512 %A_copy.data, i4* nonnull align 512 %A_copy.keep, i4* nonnull align 512 %A_copy.strb, i1* nonnull align 512 %A_copy.last, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* nonnull %B, i32* nonnull align 512 %B_copy.data, i4* nonnull align 512 %B_copy.keep, i4* nonnull align 512 %B_copy.strb, i1* nonnull align 512 %B_copy.last, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* nonnull %C, i32* nonnull align 512 %C_copy.data, i4* nonnull align 512 %C_copy.keep, i4* nonnull align 512 %C_copy.strb, i1* nonnull align 512 %C_copy.last, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* nonnull %D, i32* nonnull align 512 %D_copy.data, i4* nonnull align 512 %D_copy.keep, i4* nonnull align 512 %D_copy.strb, i1* nonnull align 512 %D_copy.last)
  call void @apatb_axis_fp_example_hw(i32* %A_copy.data, i4* %A_copy.keep, i4* %A_copy.strb, i1* %A_copy.last, i32* %B_copy.data, i4* %B_copy.keep, i4* %B_copy.strb, i1* %B_copy.last, i32* %C_copy.data, i4* %C_copy.keep, i4* %C_copy.strb, i1* %C_copy.last, i32* %D_copy.data, i4* %D_copy.keep, i4* %D_copy.strb, i1* %D_copy.last)
  call void @copy_back(%"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* %A, i32* %A_copy.data, i4* %A_copy.keep, i4* %A_copy.strb, i1* %A_copy.last, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* %B, i32* %B_copy.data, i4* %B_copy.keep, i4* %B_copy.strb, i1* %B_copy.last, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* %C, i32* %C_copy.data, i4* %C_copy.keep, i4* %C_copy.strb, i1* %C_copy.last, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* %D, i32* %D_copy.data, i4* %D_copy.keep, i4* %D_copy.strb, i1* %D_copy.last)
  ret void
}
...
declare void @apatb_axis_fp_example_hw(i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*)
...
declare void @axis_fp_example_hw_stub(%"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* noalias nonnull)

define void @axis_fp_example_hw_stub_wrapper(i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*) #5 {
entry:
  ...
  call void @axis_fp_example_hw_stub(%"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* %17, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* %19, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* %21, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* %23)
