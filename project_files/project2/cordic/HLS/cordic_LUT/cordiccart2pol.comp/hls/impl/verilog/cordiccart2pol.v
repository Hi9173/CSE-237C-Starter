...
wire   [7:0] my_LUT_r_address0;
wire   [2:0] my_LUT_r_q0;
wire   [7:0] my_LUT_th_address0;
wire   [3:0] my_LUT_th_q0;
...
assign fixed_x_fu_111_p2 = x << 4'd1;
...
assign fixed_y_fu_185_p2 = y << 4'd1;
...
assign tmp_1_fu_117_p3 = x[32'd2];

assign tmp_2_fu_177_p3 = y[32'd3];

assign tmp_3_fu_191_p3 = y[32'd2];

assign tmp_fu_103_p3 = x[32'd3];

assign trunc_ln11_fu_149_p1 = x[1:0];

assign trunc_ln12_fu_223_p1 = y[1:0];
