...
architecture behav of cordiccart2pol is 
    ...
    "cordiccart2pol_cordiccart2pol,hls_ip_2024_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.447000,HLS_SYN_LAT=1,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=2,HLS_SYN_LUT=44,HLS_VERSION=2024_2}";
    ...
    signal my_LUT_r_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal my_LUT_r_q0 : STD_LOGIC_VECTOR (3 downto 0);
    signal my_LUT_th_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal my_LUT_th_q0 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal trunc_ln11_fu_149_p1 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal fixed_x_1_fu_153_p4 : STD_LOGIC_VECTOR (4 downto 0);
    signal fixed_x_fu_111_p2 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal trunc_ln12_fu_223_p1 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal fixed_y_1_fu_227_p4 : STD_LOGIC_VECTOR (4 downto 0);
    signal fixed_y_fu_185_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal fixed_x_2_fu_169_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal fixed_y_2_fu_243_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal index_fu_251_p3 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    fixed_x_2_fu_169_p3 <= 
        ...
        fixed_x_fu_111_p2;
    fixed_x_fu_111_p2 <= std_logic_vector(shift_left(unsigned(x),to_integer(unsigned('0' & ap_const_lv5_1(5-1 downto 0)))));
    ...
    fixed_y_2_fu_243_p3 <= 
        ...
        fixed_y_fu_185_p2;
    fixed_y_fu_185_p2 <= std_logic_vector(shift_left(unsigned(y),to_integer(unsigned('0' & ap_const_lv5_1(5-1 downto 0)))));
    index_fu_251_p3 <= (fixed_x_2_fu_169_p3 & fixed_y_2_fu_243_p3);
    my_LUT_r_address0 <= zext_ln26_fu_259_p1(10 - 1 downto 0);
    ...
    my_LUT_th_address0 <= zext_ln26_fu_259_p1(10 - 1 downto 0);
    ...
    r <= std_logic_vector(IEEE.numeric_std.resize(unsigned(my_LUT_r_q0),5));
    ...
    tmp_1_fu_117_p3 <= x(3 downto 3);
    tmp_2_fu_177_p3 <= y(4 downto 4);
    tmp_3_fu_191_p3 <= y(3 downto 3);
    tmp_fu_103_p3 <= x(4 downto 4);
    trunc_ln11_fu_149_p1 <= x(3 - 1 downto 0);
    trunc_ln12_fu_223_p1 <= y(3 - 1 downto 0);
