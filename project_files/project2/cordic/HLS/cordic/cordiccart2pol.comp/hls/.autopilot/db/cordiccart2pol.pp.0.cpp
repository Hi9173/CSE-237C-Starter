...
data_t Kvalues[20] = {
    ...
    1.52587890625000e-05, 7.62939453125000e-06, 3.81469726562500e-06, 1.90734863281250e-06
};
...
data_t angles[20] = {
    ...
    1.52587890613158e-05, 7.62939453110197e-06, 3.81469726560650e-06, 1.90734863281019e-06
};

__attribute__((sdx_kernel("cordiccart2pol", 0))) void cordiccart2pol(data_t x, data_t y, data_t * r, data_t * theta)
{
#line 9 "/home/linux/ieng6/students/769/zeh003/Desktop/CSE-237C-Starter/project_files/project2/cordic/HLS/cordic/cordiccart2pol.tcl"
#pragma HLSDIRECTIVE TOP name=cordiccart2pol
# 24 "cordiccart2pol.cpp"

 data_t current_x = x;
 data_t current_y = y;
 data_t current_theta = 0;

 data_t gain = 0.6072529350088812;

 data_t x_new, y_new;
 if (current_y < 0) {
  x_new = -current_y;
  y_new = current_x;
  current_theta = current_theta - 1.5708;
 } else {
  x_new = current_y;
  y_new = -current_x;
  current_theta = current_theta + 1.5708;
 ...
 VITIS_LOOP_44_1: for(int i = 0; i < 20; i++)
 {
