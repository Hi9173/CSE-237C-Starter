...
set C_modelArgList {
	{ x int 24 regular  }
	{ y int 24 regular  }
	{ r int 24 regular {pointer 1}  }
	{ theta int 24 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "x", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "y", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "r", "interface" : "wire", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "theta", "interface" : "wire", "bitwidth" : 24, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ y sc_in sc_lv 24 signal 1 } 
	{ r sc_out sc_lv 24 signal 2 } 
	{ r_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ theta sc_out sc_lv 24 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "y", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "y", "role": "default" }} , 
 	{ "name": "r", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "r", "role": "default" }} , 
 	{ "name": "r_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "r", "role": "ap_vld" }} , 
 	{ "name": "theta", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "theta", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "7"],
		...
		"Port" : [
			...
			{"Name" : "Kvalues", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_cordiccart2pol_Pipeline_VITIS_LOOP_30_1_fu_88", "Port" : "Kvalues", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "angles", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_cordiccart2pol_Pipeline_VITIS_LOOP_30_1_fu_88", "Port" : "angles", "Inst_start_state" : "1", "Inst_end_state" : "2"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_cordiccart2pol_Pipeline_VITIS_LOOP_30_1_fu_88", "Parent" : "0", "Child" : ["2", "3", "4", "5", "6"],
	...
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_cordiccart2pol_Pipeline_VITIS_LOOP_30_1_fu_88.mul_22ns_24s_45_1_1_U1", "Parent" : "1"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_cordiccart2pol_Pipeline_VITIS_LOOP_30_1_fu_88.mul_22ns_24s_45_1_1_U2", "Parent" : "1"},
	...
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_24s_22ns_45_1_1_U11", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	y { ap_none {  { y in_data 0 24 } } }
	r { ap_vld {  { r out_data 1 24 }  { r_ap_vld out_vld 1 1 } } }
	theta { ap_vld {  { theta out_data 1 24 }  { theta_ap_vld out_vld 1 1 } } }
}
